...
func TestRunOpen_WithSlug(t *testing.T) {
	...
	if openedURL != "https://myapp.nest.gethatch.eu" {
		t.Fatalf("expected URL 'https://myapp.nest.gethatch.eu', got %q", openedURL)
	}
	if !contains(output, "https://myapp.nest.gethatch.eu") {
